...
def review_engagement(content_data: dict) -> str:
    ...
    Example:
        ...
        >>> print(review['score'])
    """
    return json.dumps(review_engagement_native(content_data=content_data), ensure_ascii=False)


def review_engagement_native(content_data: dict) -> dict:
    """评审互动潜力，返回结构化 dict。"""
    try:
...
__all__ = ['review_engagement', 'review_engagement_native']
