...
class TestConfig:
    ...
    def test_config_import(self):
        """测试配置模块可以正常导入"""
        from social_media_agent.config import Config, ModelConfig, PathConfig, MCPConfig
    ...
    def test_path_config(self):
        """测试路径配置"""
        from social_media_agent.config import PathConfig
    ...
    def test_mcp_config(self):
        """测试 MCP 配置"""
        from social_media_agent.config import MCPConfig
...
class TestConfigEnvironment:
    ...
    def test_env_loading(self, monkeypatch):
        ...
        # 重新导入以应用环境变量
        import importlib
        import social_media_agent.config as config
